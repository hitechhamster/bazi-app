...
function UpgradeCTA({ tier, locale }: { tier: string; locale: string }) {
  if (tier === 'free') {
    return (
      <div className="zen-result-card" style={{ textAlign: 'center', padding: '36px 24px' }}>
        <div style={{ fontFamily: 'var(--font-main)', fontSize: '15px', fontWeight: 500, color: 'var(--zen-ink)', marginBottom: '8px', letterSpacing: '0.03em' }}>
          Unlock the Full Picture
        </div>
        <p style={{ fontFamily: 'var(--font-ui)', fontSize: '12px', color: 'var(--zen-text-muted)', marginBottom: '20px', lineHeight: 1.6, maxWidth: '400px', margin: '0 auto 20px' }}>
          Upgrade to Pro to generate a 15,000+ word Premium Compatibility Report with 6 deep chapters — Career & Wealth, Love & Marriage, year-by-year forecast, and more.
        </p>
        <Link
  ...
  return (
    <div className="zen-result-card" style={{ textAlign: 'center', padding: '36px 24px' }}>
      ...
      <p style={{ fontFamily: 'var(--font-ui)', fontSize: '12px', color: 'var(--zen-text-muted)', marginBottom: '20px', lineHeight: 1.6 }}>
